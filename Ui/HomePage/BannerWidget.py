...
from Core.ConfigFunction.Url import HELP_URL, REPO_URL, FEEDBACK_URL
...
class BannerWidget(QWidget):
    ...
    def __init__(self, parent=None) -> None:
        ...
        self.setObjectName("PDF-ToolbxLabel")
    ...
    def setupAttribute(self) -> None:
        ...
        self.toolsLabel.setObjectName("PDFLabel")

    def createChildControls(self) -> None:
        """创建子控件"""
        self.toolsLabel = QLabel("PDF Toolbox", self)
    ...
    def addCard(self) -> None:
        ...
        self.linkCardView.addCard(
            ...
            content=self.tr(
                "This is a comprehensive toolbox equipped "
                "with all necessary PDF functions"
            ),
            url=HELP_URL,
        )
        self.linkCardView.addCard(
        ...
        self.linkCardView.addCard(
            ...
            content=self.tr("Improve PDF-Toolbox with feedback."),
            url=FEEDBACK_URL,
        )
